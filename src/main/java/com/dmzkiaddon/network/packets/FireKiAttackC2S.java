...
public class FireKiAttackC2S {
    ...
    private static void fireAttack(AttackType type, ServerPlayer player, StatsData stats, float charge) {
        ...
        // Costo = % del ENE máximo configurado, escalado por la carga
        ...
        // Daño escala con PWR (getKiDamage() incluye stat + forma + power release)
        ...
        switch (type) {
            case KAMEHAMEHA -> {
                ...
                wave.setColors(0x2266FF, 0x88BBFF); // azul / celeste
            ...
            case GALICK_GUN -> {
                ...
                wave.setColors(0x9922CC, 0xDD88FF); // morado / lila
            ...
            case FINAL_FLASH -> {
                ...
                wave.setColors(0xFFDD00, 0xFFFFAA); // amarillo / amarillo claro
            ...
            case MASENKO -> {
                KiWaveAddon wave = new KiWaveAddon(level, player, KiWaveAddon.SoundType.KAMEHAMEHA);
                wave.setColors(0xFF8800, 0xFFCC66); // naranja / naranja claro
                wave.setKiDamage(kiDamage);
            ...
            case KI_LASER -> {
                ...
                laser.setColors(0x00FFFF, 0xAAFFFF); // cian / cian claro
            ...
            case DODOMPA -> {
                ...
                dodompa.setColors(0xFF44BB, 0xFFAADD); // rosa / rosa claro
            ...
            case KI_VOLLEY -> {
                for (int i = 0; i < 5; i++) {
                    ...
                    blast.setColors(0x44FFFF, 0xAAFFFF); // cian / cian claro
            ...
            case SPIRIT_BOMB -> {
                ...
                spirit.setColors(0x88BBFF, 0xCCDDFF); // azul claro / blanco azulado
            ...
            case BIG_BANG -> {
                ...
                bigBang.setColors(0xFFFFFF, 0xDDEEFF); // blanco / blanco azulado
            ...
            case DEATH_BALL -> {
                ...
                dball.setColors(0xCC0022, 0xFF6644); // rojo oscuro / rojo naranja
            ...
            case KI_DISC -> {
                ...
                disc.setColors(0xFF44FF, 0xFFAAFF); // magenta / magenta claro
    ...
    /** Posiciona y lanza un proyectil desde el ojo del jugador. No usar para beams (KiWaveAddon/KiLaserAddon). */
