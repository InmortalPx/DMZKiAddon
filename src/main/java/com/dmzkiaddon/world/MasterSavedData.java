...
public class MasterSavedData extends SavedData {
    ...
    private BlockPos tenshinhanPos  = null;
    private BlockPos hitPos         = null;
    ...
    public static MasterSavedData load(CompoundTag tag) {
        ...
        if (tag.contains("tenshinhanX"))  d.tenshinhanPos  = new BlockPos(tag.getInt("tenshinhanX"), tag.getInt("tenshinhanY"), tag.getInt("tenshinhanZ"));
        if (tag.contains("hitX"))         d.hitPos         = new BlockPos(tag.getInt("hitX"),        tag.getInt("hitY"),        tag.getInt("hitZ"));
        return d;
    }
    ...
    public CompoundTag save(CompoundTag tag) {
        ...
        if (tenshinhanPos != null) { tag.putInt("tenshinhanX", tenshinhanPos.getX()); tag.putInt("tenshinhanY", tenshinhanPos.getY()); tag.putInt("tenshinhanZ", tenshinhanPos.getZ()); }
        if (hitPos        != null) { tag.putInt("hitX",        hitPos.getX());        tag.putInt("hitY",        hitPos.getY());        tag.putInt("hitZ",        hitPos.getZ()); }
        return tag;
    }
    ...
    public BlockPos getHitPos()           { return hitPos; }
    public void     setHitPos(BlockPos p) { this.hitPos = p; setDirty(); }
}