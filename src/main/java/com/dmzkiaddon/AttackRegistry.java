...
public class AttackRegistry {
    ...
    public static final List<KiAttackEntry> ALL = List.of(
            new KiAttackEntry(AttackType.KI_LASER,         "addon_ki_laser",         "Ki Laser",         0.0f, 1.0f, 1.0f,  10,  10, false, true),
            ...
            // Ataques especiales — tecla dedicada, no van al ciclo de KEY_FIRE
